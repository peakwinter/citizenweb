*The CitizenWeb Project:* A comprehensive walkthrough and guide to Digital Sovereignty. Explaining Linux, Personal Data Servers, and Free Software for the security-minded activist and user.
...
Topic List
	...
	1.4 Manifesto for a Decentralized Web
    2. Installing Linux
        2.1 What is Linux?
	...
	2.9 APPENDIX: The Great Big Guide to Android
	...
	3.12 Social Networking: Decentralize with Tent
        3.13 APPENDIX: Guide to Virtual Machines
        3.14 APPENDIX: Guide to FreeNAS
    4. Security on Other Systems
	4.1 Securing Mail on Windows/OS X
	4.2 Securing the Web on Windows/OS X
	4.3 Securing Chat on Windows/OS X
	4.4 Securing Files and Sharing on Windows/OS X
    5. Crash Courses
        5.1 Backup Your Data
        5.2 Automate Using bash and cron
        5.3 Personalize Your Linux Desktop
	5.4 Encrypted Browsing with Tor
...
https://github.com/jacook/citizenweb or email them direct to jacob [at] jcook [dot] cc
